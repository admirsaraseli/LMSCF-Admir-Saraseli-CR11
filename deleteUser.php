...
<body>
	...
	<div class="container mt-4 mx-auto text-center">
		...
		<form action ="actions/a_delete_user.php" method="post">
		    ...
		    <a href="super_admin.php"><button class="btn btn-secondary" type="button">No, go back!</button></a>
		</form>
	</div>
	<div class="card-footer fixed-bottom text-white bg-transparent text-center font-weight-bold"> &copy; 2020 </div>
</body>
</html>
